...
@section('content')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">New Service for {{$expert->serviceProvider->service_provider_name}}</h4>
                </div>
                    ...
                    <div class="modal-body">
                        <div class="card">
                            <div class="body">
                                ...
                                <input type="hidden" name="provider_id" value="{{$expert->serviceProvider->id}}">
                                <div class="row clearfix">
    ...
    <div class="modal fade" id="newWorkingHours" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">New Working hours for {{$expert->serviceProvider->service_provider_name}}</h4>
                </div>
        ...
        function rm_day(nm,id){
            bootbox.confirm("Remove \"" + nm + "\" from your working days? ", function(result) {
                if(result) {
                    ...
                    $.ajax({
                        url: '/expert/working_hours/delete/' + id,
                        type: 'get',
                        headers: {
                            'X-XSRF-Token': $('meta[name="_token"]').attr('content')
                        },
        ...
        function accept_appointment(nm,id){
            bootbox.confirm("Accept appointment from \"" + nm + "\" ? ", function(result) {
                if(result) {
                    ...
                    $.ajax({
                        url: '/expert/appointments/accept/' + id,
                        type: 'get',
                        headers: {
                            'X-XSRF-Token': $('meta[name="_token"]').attr('content')
                        },
        ...
        function reject_appointment(nm,id){
            bootbox.confirm("Reject appointment from \"" + nm + "\" ? ", function(result) {
                if(result) {
                    ...
                    $.ajax({
                        url: '/expert/appointments/reject/' + id,
                        type: 'get',
                        headers: {
                            'X-XSRF-Token': $('meta[name="_token"]').attr('content')
                        },
