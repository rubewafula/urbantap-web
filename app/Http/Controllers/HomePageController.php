...
class HomePageController extends Controller
{
    ...
    public function get($id=null){
        ...
        $out = ['services' =>$results[0], 
                ...
                'customer_count'=> optional(arr_get($results, '2.0'))->customer_count,
                'service_provider_count' => optional(arr_get($results, '3.0'))->service_provider_count,
                'rating_count' => optional(arr_get($results, '4.0'))->rating_count,
                'weekly_providers_count' => optional(arr_get($results, '5.0'))->weekly_providers_count,
                'popular_providers' => $popular_providers,
                'featured_providers' => arr_get($results, '5')
            ];
