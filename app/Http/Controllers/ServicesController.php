...
class ServicesController extends Controller
{
   /**
    ...
    public function get($category_id=null)
    {
        ...
        $query = "SELECT id, s.category_id, c.category_name, s.service_name FROM services s inner join categories c on c.id = s.category_id where s.status_id not in (" . DBStatus::RECORD_DELETED . ") " . $filter . " limit 100";
